const en_US = {
  ...
  team: {
    ...
    bind_services_already_bound: 'Already assigned to {{team}}',
    bind_services_name_invalid: 'The business name may only contain lowercase letters and hyphens. Rename it before adding bindings.',
    bind_services_one_team: 'A service can be assigned to only one business',
    name_pattern: 'Lowercase letters and hyphens only, e.g. turms or rome-sec',
