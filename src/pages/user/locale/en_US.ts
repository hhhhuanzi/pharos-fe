const en_US = {
  ...
  team: {
    ...
    bind_services: 'Link services',
    bind_services_title: 'Link services',
    bind_services_search: 'Search service name',
    bind_services_selected: '{{num}} selected',
    bind_services_empty: 'No services to link',
    bind_services_save_success: 'Linked services saved',
    bind_services_save_failed: 'Failed to save linked services',
    bind_services_catalog_failed: 'Failed to load service catalog',
