const en_US = {
  ...
  graph: {
    ...
    virtual: {
      ...
      no_visible_client: 'Every caller of this node belongs to another team, so no traces are queried here.',
    ...
    node: {
      ...
      resources_restricted: 'This service is not in your team scope, so its traces are not queried. Upstream / downstream and RED above still apply.',
      no_jaeger: 'No tracing datasource available, so traces cannot be queried.',
      load_failed: 'Failed to query traces.',
